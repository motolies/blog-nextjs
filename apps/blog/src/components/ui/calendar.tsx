  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        [UI.Month]: 'relative w-full min-w-[17rem] space-y-4',
        [UI.MonthCaption]:
        ...
        [UI.Dropdown]: 'absolute inset-0 z-10 h-full w-full cursor-pointer rounded-xl opacity-0',
        [UI.CaptionLabel]:
        ...
        [UI.Nav]: 'absolute top-2.5 right-3 flex items-center gap-1',
        ...
        [UI.Chevron]: 'size-4',
        [UI.MonthGrid]: 'w-full border-separate border-spacing-x-1 border-spacing-y-1.5',
        [UI.Weekdays]: '',
        [UI.Weekday]:
