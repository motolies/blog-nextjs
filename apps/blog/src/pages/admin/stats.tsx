        ...
        <>
          ...
          <div className="admin-panel overflow-x-auto mb-4">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr>
                  <th className="border-b border-[color:var(--admin-border)] bg-slate-50/80 px-4 py-2.5 text-left font-bold text-[color:var(--admin-text)]">
                    순위
                  </th>
                  <th className="border-b border-[color:var(--admin-border)] bg-slate-50/80 px-4 py-2.5 text-left font-bold text-[color:var(--admin-text)]">
                    제목
                  ...
                  <th className="border-b border-[color:var(--admin-border)] bg-slate-50/80 px-4 py-2.5 text-right font-bold text-[color:var(--admin-text)]">
                    조회수
                  </th>
                </tr>
              </thead>
              <tbody>
                {data.popularPosts.map((post, index) => (
                  <tr
                    key={post.id}
                    className="text-[color:var(--admin-text-secondary)] hover:bg-sky-500/5"
                  >
