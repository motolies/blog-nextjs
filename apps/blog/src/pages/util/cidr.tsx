    ...
    <>
      <div className="border rounded-md p-4 mb-4">
        ...
        {rangeResult.error ? (
          ...
          <p className="text-xs text-gray-500 dark:text-[#636d83] mt-2">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b">
                  ...
                  <th className="text-right py-2 px-3 font-medium text-gray-600 dark:text-[#7c8496]">
                    주소 수
                  </th>
                </tr>
              </thead>
            ...
            <div className="max-h-96 overflow-auto">
              <table className="w-full text-sm">
                <thead className="sticky top-0 bg-white/95 dark:bg-[rgba(33,37,43,0.95)]">
                  <tr className="border-b">
                    <th className="text-left py-2 px-3 w-20 font-medium text-gray-600 dark:text-[#7c8496]">
                      프리픽스
                    </th>
                    <th className="text-left py-2 px-3 font-medium text-gray-600 dark:text-[#7c8496]">
                      넷마스크
