            ...
            <TabsContent value="convert">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-3">
                  ...
                  />
                  <Button onClick={handleTsidToNumber} className="w-full">
                    변환
                  </Button>
                ...
                <div className="space-y-3">
                  ...
                  />
                  <Button onClick={handleNumberToTsid} className="w-full">
                    변환
                  </Button>
            ...
            <TabsContent value="date">
              ...
              <div className="space-y-3">
                <Input
                  ...
                  placeholder="예: 0GXWP1VXZS35J"
                />
                <Button onClick={handleTsidToDate} className="w-full">
                  날짜/시간 추출
                </Button>
