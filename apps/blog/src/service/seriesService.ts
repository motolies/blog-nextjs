...
const seriesService = {
  ...
  update: (
    { seriesId, title, description }: { seriesId: string; title: string; description?: string },
    config?: AxiosRequestConfig,
  ) => {
  ...
  addPost: (
    { seriesId, postId }: { seriesId: string; postId: string },
    config?: AxiosRequestConfig,
  ) => {
    return axiosClient.post(
      `/api/series/admin/${seriesId}/posts`,
  ...
  reorderPosts: (
    { seriesId, postIds }: { seriesId: string; postIds: number[] },
    config?: AxiosRequestConfig,
  ) => {
