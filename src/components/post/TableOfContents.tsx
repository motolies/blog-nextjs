...
const DEPTH_STYLES = [
    {indent: 'pl-0', size: 'text-sm', weight: 'font-semibold', color: 'text-slate-950 dark:text-slate-100'},
    {indent: 'pl-3', size: 'text-sm', weight: 'font-normal', color: 'text-[color:var(--public-text-muted)]'},
    {indent: 'pl-6', size: 'text-xs', weight: 'font-normal', color: 'text-[color:var(--public-text-muted)]'},
    {indent: 'pl-9', size: 'text-xs', weight: 'font-normal', color: 'text-[color:var(--public-text-subtle)]'},
] as const
...
export default function TableOfContents({postBody}: TableOfContentsProps) {
    ...
    useEffect(() => {
        ...
        const frameId = requestAnimationFrame(() => {
            ...
            const depths = normalizeHeadingDepths(collected.map(item => item.level), MAX_DEPTH)
