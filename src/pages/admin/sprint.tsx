...
export default function SprintPage() {
    ...
    const getTableData = () => {
        if (!sprintData) return {headers: [] as string[], rows: [] as any[][], sprints: [] as string[]}
        const {sprints = [], assigneeSummaries = []} = sprintData
        ...
        const sprintTotalsRow = [
            ...
            assigneeSummaries.reduce((total: number, assignee: any) => total + (assignee.totalStoryPoints || 0), 0)
        ]
